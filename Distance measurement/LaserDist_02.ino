/*
 * STMicroelectronic VL53L0X Laser Distance Sensor
...
void loop() {
 ...
 // measTime_mS = millis();
  ...
  Serial.print("Distance: ");  Serial.print(distance_mm);  Serial.print("  "); Serial.print(millis() - measTime_mS); 
  Serial.print("  M/Sec: "); Serial.print((float)(1000 / ((float)millis() - (float)measTime_mS)) );
